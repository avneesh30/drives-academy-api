...
function up(knex) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, knex.schema.createTable('user_quiz_results', function (table) {
...
function down(knex) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, knex.schema.dropTable('user_quiz_results')];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
...
exports.down = down;
//# sourceMappingURL=20250413141149_create_user_quiz_results.js.map